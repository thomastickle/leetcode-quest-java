...
class Question2Test {
    ...
    void shuffle() {
        ...
        assertArrayEquals(expectedExample1Output, question2.shuffle(example1Input, example1Midpoint));

        int[] example2Input = {1,2,3,4,4,3,2,1};
        int example2Midpoint = 4;
        int[] expectedExample2Output = {1,4,2,3,3,2,4,1};
        assertArrayEquals(expectedExample2Output, question2.shuffle(example2Input, example2Midpoint));


        int[] example3Input = {1,1,2,2};
        int example3Midpoint = 2;
        int[] expectedExample3Output = {1,2,1,2};
        assertArrayEquals(expectedExample3Output, question2.shuffle(example3Input, example3Midpoint));
    }
}